...
class TestBurger:
    ...
    def test_move_ingredient(self, burger, ingredient_mock, other_ingredient_mock):
        burger.add_ingredient(ingredient_mock)
        burger.add_ingredient(other_ingredient_mock)
        burger.move_ingredient(1, 0)
        assert burger.ingredients[0] == other_ingredient_mock

    def test_get_price_ingredient(self,burger, bun_mock, ingredient_mock, other_ingredient_mock):
        burger.set_buns(bun_mock)
        burger.add_ingredient(ingredient_mock)
        burger.add_ingredient(other_ingredient_mock)
    ...
    def test_get_receipt(self, burger, bun_mock, ingredient_mock, other_ingredient_mock):
        burger.set_buns(bun_mock)
        burger.add_ingredient(ingredient_mock)
        burger.add_ingredient(other_ingredient_mock)
        receipt = burger.get_receipt()
        assert "(==== hot bun ====)" and "= sause test sause =" and "= filling test filling =" and "Price: 174" in receipt
