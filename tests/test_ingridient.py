...
def test_ingredient_init_type(ingredient_type,name, price):
...
def test_ingredient_init_name(ingredient_type,name, price):
    ing = Ingredient(ingredient_type,name,price)
...
def test_ingredient_init_price(ingredient_type,name, price):
    ing = Ingredient(ingredient_type,name,price)
